          ...
          {Array.from({ length: daysInMonth }).map((_, i) => {
            ...
            return (
              <motion.button
                ...
                className={`
                  h-14 md:h-20 w-full bg-green-70 rounded-2xl flex flex-col items-center justify-center transition-all relative overflow-hidden
                  ${isSelected ? 'bg-[#2d3a2d] text-white shadow-xl ring-4 ring-[#2d3a2d]/10' : ''}
                  ${isBooked ? 'bg-red-70 text-red-300 cursor-not-allowed border border-red-100' : ''}
